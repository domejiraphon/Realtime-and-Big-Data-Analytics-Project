...
public class AirAggPRESSMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public void map(LongWritable key, Text value, Context context)
        ...
        try {
            ...
            // value: flag(PRESS),barometric pressure
            String outVal = String.format("PRESS,%s,%d", strArr[statCOL],ONE);
